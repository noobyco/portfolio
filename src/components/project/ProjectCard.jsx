        ...
        <div className="mb-[5rem]">
            ...
            <div>
                ...
                <br/>
                {
                    ...
                    <a href={props.codebaseUrl}>Codebase <span><BsArrowUpRight className="inline mb-2"/></span></a></button>)
                }
                
                {
                    props.projectUrl && (<button className="bg-slate-100 rounded-full p-2 m-1  hover:bg-black hover:text-white">
                    <a href={props.projectUrl}>Project <span><BsArrowUpRight className="inline mb-2"/></span></a></button>)
                }

                {
                    props.videoUrl && (<button className="bg-slate-100 rounded-full p-2 m-1 hover:bg-black hover:text-white">
                    <a href={props.videoUrl}>Video <span><BsArrowUpRight className="inline mb-2"/></span></a></button>)
                }
